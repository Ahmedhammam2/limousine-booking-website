        ...
        <div className="md:hidden divide-y">
          {filteredBooking.map((booking) => {
            ...
            return (
              <div
                key={booking._id}
                className={`p-4 space-y-3 ${!isEditable ? "bg-gray-100 text-gray-400" : ""
                  }`}
              >
                ...
                <div className="flex flex-col gap-2 pt-2">
                  {isEditable && (
                    <Link
                      href={`/booking/?edit=true&bookingId=${booking._id}`}
                      className="w-full text-center px-3 py-2 text-sm font-medium rounded bg-blue-100 text-blue-700 hover:bg-blue-200 block"
                    >
                      Edit Booking
                    </Link>
                  )}
