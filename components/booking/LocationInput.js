    ...
    <div className="text-black space-y-4 sm:space-y-6">
      ...
      <div className="relative">
        <AutocompleteInput
          ...
          className="w-full pl-9 sm:pl-10 pr-9 sm:pr-10 py-2 text-sm sm:text-base border border-[#333333] rounded-md bg-white text-black focus:outline-none focus:border-black transition"
        />
            ...
            <div className="relative flex items-center gap-2">
              <div className="relative flex-grow">
                <AutocompleteInput
                  ...
                  className="w-full pl-9 sm:pl-10 pr-9 sm:pr-12 py-2 text-sm sm:text-base border border-[#333333] rounded-md bg-white text-black focus:outline-none focus:border-black transition"
                />
