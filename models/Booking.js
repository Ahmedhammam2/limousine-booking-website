...
// mongoDB TTL index to delete bookings after 15 minutes if not paid  
bookingSchema.index(
  { createdAt: 1 },
  {
    expireAfterSeconds: 1800, // 30 minutes in seconds
    partialFilterExpression: { paymentStatus: "unpaid" } // Only delete documents with status unpaid
  }
);
